  ...
  return <div className="bg-primary/60  h-full ">
    ...
    <div className="text-center flex flex-col justify-center xl:pt-40 xl:text-left h-full container mx-auto ">
      ...
      variants={fadeIn("down", 0.2)} initial="hidden" animate="show" exit="hidden" 
       className="h1">New Prime <br />  <span className="text-accent">University</span>
      </motion.h1>
      {/* subtitle */}
      <motion.p 
      variants={fadeIn("down", 0.3)} initial="hidden" animate="show" exit="hidden" 
      className="max-w-sm xl:max-w-xl mx-auto xl:mx-0 mb-10 xl:mb-16">Donde el futuro del emprendimiento cobra vida! 🚀 Descubre, aprende y
       crece con nuestra plataforma llena de recursos GRATIS. ¡El éxito está 
       a un clic de distancia! 💡📈</motion.p>
       {/* btn */}
