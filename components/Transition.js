...
const Transition = () => {
  return (
    <>
      ...
      bg-[#000000]' variants={transitionVariants} initial="initial" animate="animate" exit="exit"
      ...
      bg-[#1a1a1a]' variants={transitionVariants} initial="initial" animate="animate" exit="exit"
      ...
      bg-[#0000000]' variants={transitionVariants} initial="initial" animate="animate" exit="exit"
      transition={{delay: 0.25, duration: 0.6, ease: "easeInOut"}}></motion.div> 
    </>
  );
};
