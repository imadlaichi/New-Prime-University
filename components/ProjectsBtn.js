...
const ProjectsBtn = () => {
  return <div className="mx-auto xl:mx-0 z-10">
     <Link href={"https://discord.gg/ckJgsmeEw4"} className="relative w-[185px] h-[185px] flex justify-center items-center bg-circleS  tar bg-cover bg-center bg-no-repeat group">
